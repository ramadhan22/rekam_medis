						...
						<div class="col-md-12">
							...
							<div class="box">
								<div class="box-body table-responsive">
									<a href="tambah.php"><button type="button" class="btn btn-default btn-sm">Tambah Data Poliklinik</button></a>
									<table class="table table-bordered table-responsive">
									  	...
									  	<tbody>
									  		<?php 
									  			$jumlah = jumlah_data('tb_poliklinik');
									  			$batas = 10;
									  			...
									  			$start = ($page-1) * $batas;
									  			$no = $start;
									  			$data = ambil_semua_data('tb_poliklinik',$start,$batas);
									  			...
									  			<tr align="center">
									  				...
									  				<td>
									  					<div class="btn-group">
										  					<a href="ubah.php?id=<?php echo $row['kd_poli'] ?>" class="btn btn-default btn-small" >Ubah</a>
										  					<a href="hapus.php?id=<?php echo $row['kd_poli'] ?>" class="btn btn-danger btn-small" onclick="return confirm('Anda yakin ingin menghapus?')">Hapus</a>
									  					</div>
									  				</td>
									  			</tr>
									  			<?php
